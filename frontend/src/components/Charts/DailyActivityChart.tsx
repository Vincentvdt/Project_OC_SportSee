    ...
    return (
        <ChartContainer width={"100%"}
            ...
            <BarChart data={data.sessions} barGap={8}>
                ...
                <XAxis tickFormatter={(index) => ((index as number) + 1).toString()}
                       tickMargin={10}
                       tickSize={14}
                       tickLine={false}
                       tick={{
                ...
                <Legend
                    ...
                    formatter={(value, entry) =>
                        <LegendText> {value} ({(entry.payload as PayloadType).unit}) </LegendText>}/>
                <Bar name="Poids" unit="kg" dataKey="kilogram" fill="#282D30" barSize={7} radius={[10, 10, 0, 0]}/>
